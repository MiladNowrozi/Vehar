              ...
              {Galeyre.slice(0, 2).map((News, i) => (
                <div key={i} className="ItemSliderCenter">
                  <div className="imgCenter1">
                    {<img accessKey={News.id} onClick={GetDataNews} className="SliderImgCenter" src={News.img} alt="imgs" />}
                  </div>
            ...
            {Galeyre.slice(2, 3).map((News, i) => (
              <div key={i} className="ItemsSliderRight">
                <div className="imgRight">
                  {<img accessKey={News.id} onClick={GetDataNews} className="SliderImgRight" src={News.img} alt="imgs" />}
                </div>
            ...
            <div key={i} className="Content-Gallery">
              <div className="NewsItems-Gallery">
                <div className="imgNews-Gallery">
                  {<img accessKey={News.id} onClick={GetDataNews} className="imgStyleHeader-Gallery" src={News.img} alt="imgs" />}
                </div>
                <div className="Content-Texts-Dallery">
                  ...
                  <div className="titleNews-Gallery">
                    <h1 accessKey={News.id} onClick={GetDataNews} className="HeadlineNewsHeader-Gallery">
                      {News.headline}
                    </h1>
                  </div>
                </div>
                    ...
                    <div className="NewsItems">
                      <div className="img-content">
                        <div className="ImgNews">
                          {<img accessKey={News.id} onClick={GetDataNews} className="imgStyleHeader" src={News.img} alt="imgs" />}
                        </div>
                      </div>
                      <div className="RoutingNews">
                        <div>
                          ...
                          <a className="titleNews">
                            <h1 accessKey={News.id} onClick={GetDataNews} className="HeadlineNewsHeader">
                              {News.headline}
                            </h1>
                          </a>
                        </div>
                  ...
                  <div className="ContainerAuthorNews">
                    <div className="ContentAuthor">
                      <div className="ImgAuthor">
                        {<img accessKey={News.id} onClick={GetDataNews} className="imgAuthor" src={News.img} alt="imgs" />}
                      </div>
