...
export const LoginAndRegister = () => {
	...
	return (
		<div className="container-auth">
			{/* start login part */}
			<div id="login-content" style={{ right: window.innerWidth > 500 ? "35%" : "10%" }} className="login-content">
						...
						<div className="btn-login">
							<button
								onClick={() => {
									...
									document.getElementById("forgot-password").style.right = window.innerWidth > 500 ? "35%" : "10%";
								}}
								type="button"
							>
								فراموشی رمز عبور!
							...
							<button
								onClick={() => {
									document.getElementById("login-content").style.right = window.innerWidth > 500 ? "100%" : "-80%";
									document.getElementById("register-content").style.right = window.innerWidth > 500 ? "35%" : "10%";
								}}
								type="button"
							>
								ثبت نام
			...
			<div id="forgot-password" style={{ right: window.innerWidth > 500 ? "-35%" : "-80%" }} className="forgot-password">
				...
				<form className="forgot-form" id="forgot-form" action="">
					...
					<div className="other-info-forgot">
						...
						<div className="btn-forgot">
							...
							<button
								onClick={() => {
									document.getElementById("forgot-password").style.right = window.innerWidth > 500 ? "-35%" : "100%";
									document.getElementById("login-content").style.right = window.innerWidth > 500 ? "35%" : "10%";
								}}
								type="button"
							>
								صفحه ورود
			...
			<div id="register-content" style={{ right: window.innerWidth > 500 ? "-35%" : "-80%" }} className="register-content">
				...
				<form className="register-form" id="register-form" action="">
					...
					<div className="other-info-register">
						...
						<button
							onClick={() => {
								document.getElementById("login-content").style.right = window.innerWidth > 500 ? "35%" : "10%";
								document.getElementById("register-content").style.right = window.innerWidth > 500 ? "-35%" : "-80%";
							}}
							type="button"
						>
							صفحه ورود
